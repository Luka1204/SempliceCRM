    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Manage your business contacts and relationships</p>
            </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 border-b border-gray-200">
                    <form method="GET" action="{{ route('companies.search') }}" class="flex gap-4 items-end">
                        <div class="flex-1">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ $companies->total() }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class="ml-4">
                                                        ...
                                                        @if($company->website)
                                                            <div class="text-sm text-gray-500">
                                                                <a href="{{ $company->website }}" target="_blank" class="text-blue-600 hover:text-blue-900 truncate block max-w-xs">
                                                ...
                                                <div class="flex space-x-2">
                                                    ...
                                                    <form action="{{ route('companies.destroy', $company) }}" method="POST" class="inline">
                                                        ...
                                                        <button type="submit" 
                                                                ...
                                                                onclick="return confirm('Are you sure you want to delete {{ $company->name }}? This action cannot be undone.')"
                                                                title="Delete">
                                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
